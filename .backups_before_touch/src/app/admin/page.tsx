...
import {
    ...
    ChevronRight, Zap, Globe, Image as ImageIcon, Sparkles, ArrowLeft, Copy, Network, Clock, Search,
    Megaphone, Instagram, PlaneTakeoff, Music
} from 'lucide-react';
    ...
    return (
        <div className="h-screen bg-[#050505] text-neutral-100 flex flex-col font-sans selection:bg-blue-500/30">
            ...
            <header className="h-20 border-b border-white/5 px-10 flex items-center justify-between bg-black/40 backdrop-blur-2xl sticky top-0 z-[100]">
                ...
                <div className="flex items-center gap-6">
                    {/* Status Pill */}
                    <div className={`flex items-center gap-3 px-4 py-2 rounded-md text-[10px] font-black uppercase transition-all border
                                    ...
                                    <div className="sticky top-0 z-20 bg-[#080808] pb-6 flex justify-between items-center gap-4">
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div className="flex bg-black/40 rounded-full p-1 border border-white/5">
                                                <button
                                                    ...
                                                    className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase transition-all ${catalogView === 'categories' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'text-neutral-500 hover:text-white'}`}
                                                >
                                                    Categorías
                                                </button>
                                                <button
                                                    onClick={() => setCatalogView('products')}
                                                    className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase transition-all ${catalogView === 'products' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'text-neutral-500 hover:text-white'}`}
                                                >
                                                    Productos
                                                </button>
                                            </div>
                                        ...
                                        {catalogView === 'products' ? (
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 bg-blue-500/10 text-blue-500 hover:bg-blue-500 hover:text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 border border-blue-500/20"
                                            >
                                        ...
                                        {catalogView === 'categories' ? (
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {allCategories.map((cat, idx) => (
                                                    <div key={cat.id} className="bg-[#111] p-5 rounded-md border border-white/5 space-y-4 group hover:border-blue-500/20 transition-all">
                                                        <div className="flex gap-5">
                                                            <div className="w-20 h-20 rounded-lg overflow-hidden bg-black flex-shrink-0 border border-white/10 relative group/catimg">
                                                                <img src={cat.photo || 'https://via.placeholder.com/150'} className="w-full h-full object-cover opacity-60 group-hover/catimg:opacity-100 transition-opacity" />
                                                                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover/catimg:opacity-100 transition-opacity flex items-center justify-center">
                                                                    <ImageUpload compact onUploadSuccess={(url) => {
                                                            ...
                                                            <div className="flex-1 space-y-2">
                                                                <input
                                                                    className="w-full bg-transparent border-none text-[15px] font-black text-white p-0 focus:ring-0 italic"
                                                                    value={cat.name}
                                                                    onChange={(e) => {
                                                                        const newCats = [...allCategories];
                                                                ...
                                                                />
                                                                <textarea
                                                                    className="w-full bg-transparent border-none text-[10px] text-neutral-500 p-0 focus:ring-0 resize-none h-12"
                                                            ...
                                                            <button onClick={() => setAllCategories(allCategories.filter((_, i) => i !== idx))} className="text-red-500/20 hover:text-red-500 transition-all self-start p-2">
                                                                <Trash2 className="w-4 h-4" />
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            allProducts.map((p, idx) => (
                                                <div key={p.id} className="bg-[#111] p-5 rounded-md border border-white/5 space-y-4 group relative hover:border-emerald-500/20 transition-all">
                                                    <div className="flex gap-5">
                                                        ...
                                                        <div className="flex-1 space-y-3">
                                                            <input
                                                                className="w-full bg-transparent border-none text-[16px] font-black text-white p-0 focus:ring-0 placeholder:text-neutral-800 italic"
                                                                value={p.name}
                                                            ...
                                                            <div className="flex flex-col gap-2">
                                                                <div className="flex items-center gap-2 mb-1">
                                                                    <div className="relative group/search flex-1">
                                                                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-neutral-600 group-focus-within/search:text-blue-500" />
                                                                        <input
                                                                            type="text"
                                                                            placeholder="VINCULAR CATEGORÍAS..."
                                                                            className="w-full bg-black/40 border border-white/5 rounded-lg pl-8 pr-3 py-2 text-[8px] font-black uppercase tracking-widest outline-none focus:border-blue-500/30 transition-all placeholder:text-neutral-700"
                                                                            onChange={(e) => {
                                                                ...
                                                                <div className="flex flex-wrap gap-2 max-h-32 overflow-y-auto custom-scrollbar-hidden pr-2">
                                                                    {allCategories.filter(c => p._catSearch ? c.name.toLowerCase().includes(p._catSearch) : true).map(cat => (
                                                                        <button
                                                                            key={cat.id}
                                                                            onClick={() => {
                                                                                const newP = [...allProducts];
                                                                                const current = newP[idx].categoryIds || [];
                                                                                newP[idx].categoryIds = current.includes(cat.id)
                                                                                    ? current.filter((id: string) => id !== cat.id)
                                                                                    : [...current, cat.id];
                                                                                setAllProducts(newP);
                                                                            }}
                                                                            className={`px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-[0.2em] transition-all border flex items-center gap-2 ${(p.categoryIds || []).includes(cat.id)
                                                                                ? 'bg-emerald-500 border-emerald-500 text-white translate-y-[-2px] shadow-lg shadow-emerald-500/20'
                                                                                : 'bg-[#111] border-white/5 text-neutral-500 hover:border-white/20'
                                                                                }`}
                                                                        >
                                                                            {(p.categoryIds || []).includes(cat.id) && <Sparkles className="w-2.5 h-2.5" />}
                                                                            {cat.name}
                                                                        </button>
                                                                    ))}
                                                                    {allCategories.length === 0 && <span className="text-[8px] text-neutral-700 font-bold uppercase tracking-widest italic">(Sin Categorías)</span>}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-2 bg-black/40 px-4 py-2 rounded-xl border border-white/5 h-fit self-center">
                                                            <span className="text-xs text-neutral-600 font-black uppercase">$</span>
                                                            <input
                                                                className="w-16 bg-transparent border-none text-lg font-black text-emerald-500 p-0 focus:ring-0 font-mono tracking-tighter"
                                                                value={p.price}
                                                                type="number"
                                                                onChange={(e) => {
                                                                    const newP = [...allProducts];
                                                    ...
                                                    <div className="flex justify-between items-center pt-2 border-t border-white/5">
                                                        <div className="text-[9px] font-bold text-neutral-700 uppercase tracking-widest italic">Product ID: {p.id.substring(0, 8)}</div>
                                                        <button
                                ...
                                >
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button
                                            ...
                                            className="p-2 bg-amber-500/10 text-amber-500 hover:bg-amber-500 hover:text-white rounded-md transition-all"
                                        >
                                    ...
                                    <div className="space-y-4 max-h-[calc(100vh-250px)] overflow-y-auto pr-2 custom-scrollbar">
                                        {allActivities.map((a, idx) => (
                                            <div key={idx} className="bg-[#111] p-4 rounded-md border border-white/5 space-y-4">
                        ...
                        selectedWidget ? (
                                            ...
                                            {selectedWidget.type === 'PRODUCT_LIST' && (
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2 bg-black/20 p-3 rounded-lg border border-white/5 max-h-40 overflow-y-auto custom-scrollbar">
                                                            {Array.from(new Set(allProducts.map(p => p.category).filter(Boolean))).map((cat) => (
                                                                <label key={cat} className="flex items-center gap-2 cursor-pointer hover:bg-white/5 p-1 rounded transition-colors">
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={selectedWidget.data.categoriesToShow?.includes(cat)}
                                                                        onChange={(e) => {
                                                                        ...
                                                                        className="w-3 h-3 rounded bg-[#111] border-white/10 checked:bg-blue-500 checked:border-blue-500 appearance-none cursor-pointer"
                                                                    />
                                                                    <span className="text-[9px] font-black text-neutral-400 uppercase">{cat}</span>
                                                                </label>
                                                            ))}
                                                            {Array.from(new Set(allProducts.map(p => p.category).filter(Boolean))).length === 0 && (
                                                                <p className="col-span-2 text-[9px] text-neutral-600 italic">No hay categorías definidas en el catálogo.</p>
                                                            )}
                                                        </div>
                                                    </div>
                            ...
                            <div className="flex-1 flex flex-col p-8 space-y-10 overflow-y-auto">
                                <div className="relative group">
                                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl blur opacity-10 group-hover:opacity-20 transition-opacity" />
                                    <div className="bg-[#111] p-8 rounded-xl border border-white/5 space-y-8 relative">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-6 pt-6 border-t border-white/5 bg-blue-500/5 -mx-8 px-8 py-6 rounded-b-xl">
