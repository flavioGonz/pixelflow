...
interface WidgetPaletteProps {
    ...
    /** 'horizontal' = top centered horizontal pill, 'floating' = left vertical pill (legacy), 'inline' = sidebar */
...
export const WidgetPalette: React.FC<WidgetPaletteProps> = ({ onAdd, variant = 'horizontal' }) => {
    ...
    if (variant === 'horizontal') {
        return (
            <TooltipProvider>
                <div
                    className="fixed top-3 left-1/2 -translate-x-1/2 z-30 flex items-center gap-0.5 p-1.5 rounded-lg border bg-popover text-popover-foreground shadow-lg backdrop-blur-xl"
